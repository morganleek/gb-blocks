...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__posts_posts_js__ = __webpack_require__(/*! ./posts/posts.js */ 12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__terms_terms_js__ = __webpack_require__(/*! ./terms/terms.js */ 15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__gallery_gallery_js__ = __webpack_require__(/*! ./gallery/gallery.js */ 18);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__attributes_attributes_js__ = __webpack_require__(/*! ./attributes/attributes.js */ 21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__accordion_accordion_js__ = __webpack_require__(/*! ./accordion/accordion.js */ 23);
/**
 * Gutenberg Blocks
 *
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss__ = __webpack_require__(/*! ./editor.scss */ 6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__editor_scss__);
...
/*!*********************************************************!*\
  ...
  \*********************************************************/
/*! exports provided: Autocomplete, BicyclingLayer, Circle, Data, DirectionsRenderer, DirectionsService, DistanceMatrixService, DrawingManager, GoogleMap, GoogleMapsMarkerClusterer, GoogleMarkerClusterer, GroundOverlay, HeatmapLayer, InfoBox, InfoWindow, KmlLayer, LoadScript, LoadScriptNext, MapContext, Marker, MarkerClusterer, OverlayView, Polygon, Polyline, Rectangle, StandaloneSearchBox, StreetViewPanorama, StreetViewService, TrafficLayer, TransitLayer, useGoogleMap, useJsApiLoader, useLoadScript */
/*! exports used: GoogleMap, LoadScript, Marker */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(global, process) {/* unused harmony export Autocomplete */
...
/* unused harmony export GoogleMapsMarkerClusterer */
/* unused harmony export GoogleMarkerClusterer */
...
const MapContext = Object(__WEBPACK_IMPORTED_MODULE_0_react__["createContext"])(null);
function useGoogleMap() {
    invariant_1(!!__WEBPACK_IMPORTED_MODULE_0_react__["useContext"], 'useGoogleMap is React hook and requires React version 16.8+');
    const map = Object(__WEBPACK_IMPORTED_MODULE_0_react__["useContext"])(MapContext);
...
//   )
// }
class GoogleMap extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
            map: null,
    ...
    render() {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { id: this.props.id, ref: this.getRef, style: this.props.mapContainerStyle, className: this.props.mapContainerClassName },
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](MapContext.Provider, { value: this.state.map }, this.state.map !== null ? this.props.children : __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0_react__["Fragment"], null))));
    }
}
...
class LoadScript extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.check = __WEBPACK_IMPORTED_MODULE_0_react__["createRef"]();
        this.state = {
            loaded: false,
        };
    ...
    render() {
        return (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0_react__["Fragment"], null,
            __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { ref: this.check }),
            this.state.loaded
                ? this.props.children
                : this.props.loadingElement || __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](DefaultLoadingElement, null)));
    }
}
...
function useLoadScript({ id = defaultLoadScriptProps.id, version = defaultLoadScriptProps.version, nonce, googleMapsApiKey, googleMapsClientId, language, region, libraries, preventGoogleFontsLoading, channel, mapIds, }) {
    const isMounted = __WEBPACK_IMPORTED_MODULE_0_react__["useRef"](false);
    const [isLoaded, setLoaded] = __WEBPACK_IMPORTED_MODULE_0_react__["useState"](false);
    const [loadError, setLoadError] = __WEBPACK_IMPORTED_MODULE_0_react__["useState"](undefined);
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function trackMountedState() {
        isMounted.current = true;
        return () => {
            isMounted.current = false;
        };
    }, []);
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function applyPreventGoogleFonts() {
        if (isBrowser && preventGoogleFontsLoading) {
            preventGoogleFonts();
        }
    }, [preventGoogleFontsLoading]);
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function validateLoadedState() {
        if (isLoaded) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function loadScriptAndModifyLoadedState() {
        if (!isBrowser) {
            return;
        }
    ...
    const prevLibraries = __WEBPACK_IMPORTED_MODULE_0_react__["useRef"]();
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function checkPerformance() {
...
const defaultLoadingElement = __WEBPACK_IMPORTED_MODULE_0_react__["createElement"](DefaultLoadingElement, null);
function LoadScriptNext(_a) {
    ...
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function handleOnLoad() {
        if (isLoaded && typeof onLoad === 'function') {
            onLoad();
        }
    }, [isLoaded, onLoad]);
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function handleOnError() {
        if (loadError && typeof onError === 'function') {
            onError(loadError);
        }
    }, [loadError, onError]);
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function handleOnUnmount() {
        return () => {
            if (onUnmount) {
                onUnmount();
            }
...
var LoadScriptNext$1 = __WEBPACK_IMPORTED_MODULE_0_react__["memo"](LoadScriptNext);
...
mapIds, }) {
    ...
    const loader = __WEBPACK_IMPORTED_MODULE_0_react__["useMemo"](function memo() {
        return new Loader({
            id,
    ...
    __WEBPACK_IMPORTED_MODULE_0_react__["useEffect"](function effect() {
        if (isLoaded) {
            return;
        }
        else {
...
class TrafficLayer extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
            trafficLayer: null,
...
class BicyclingLayer extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
            bicyclingLayer: null,
...
class TransitLayer extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
            transitLayer: null,
...
class DrawingManager extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor(props) {
        super(props);
        this.registeredEvents = [];
        this.state = {
...
class Marker extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
    }
    ...
    render() {
        ...
        if (this.props.children) {
            children = __WEBPACK_IMPORTED_MODULE_0_react__["Children"].map(this.props.children, child => {
                if (!__WEBPACK_IMPORTED_MODULE_0_react__["isValidElement"](child)) {
                    return child;
                }
                let elementChild = child;
                return __WEBPACK_IMPORTED_MODULE_0_react__["cloneElement"](elementChild, { anchor: this.marker });
            });
        }
...
class ClustererComponent extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class InfoBoxComponent extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
    ...
    render() {
        ...
        return __WEBPACK_IMPORTED_MODULE_1_react_dom__["createPortal"](__WEBPACK_IMPORTED_MODULE_0_react__["Children"].only(this.props.children), this.containerElement);
    }
}
...
const useGoogleMarkerClusterer = (options) => {
    ...
    const [markerClusterer, setMarkerClusterer] = Object(__WEBPACK_IMPORTED_MODULE_0_react__["useState"])(null);
...
class InfoWindow extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.containerElement = null;
    ...
    render() {
        return this.containerElement ? (__WEBPACK_IMPORTED_MODULE_1_react_dom__["createPortal"](__WEBPACK_IMPORTED_MODULE_0_react__["Children"].only(this.props.children), this.containerElement)) : (__WEBPACK_IMPORTED_MODULE_0_react__["createElement"](__WEBPACK_IMPORTED_MODULE_0_react__["Fragment"], null));
    }
}
...
class Polyline extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class Polygon extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class Rectangle extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class Circle extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class Data extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class KmlLayer extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class OverlayView extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor(props) {
        super(props);
        this.state = {
            paneEl: null,
        ...
        this.containerRef = __WEBPACK_IMPORTED_MODULE_0_react__["createRef"]();
    ...
    render() {
        ...
        if (paneEl) {
            return __WEBPACK_IMPORTED_MODULE_1_react_dom__["createPortal"](__WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { ref: this.containerRef, style: this.state.containerStyle }, __WEBPACK_IMPORTED_MODULE_0_react__["Children"].only(this.props.children)), paneEl);
        }
        else {
            return null;
        }
...
class GroundOverlay extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class HeatmapLayer extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class StreetViewPanorama extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class StreetViewService extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
...
class DirectionsService extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
...
class DirectionsRenderer extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.state = {
...
class DistanceMatrixService extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.state = {
...
class StandaloneSearchBox extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    constructor() {
        super(...arguments);
        this.registeredEvents = [];
        this.containerElement = __WEBPACK_IMPORTED_MODULE_0_react__["createRef"]();
        this.state = {
            searchBox: null,
        };
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { ref: this.containerElement }, __WEBPACK_IMPORTED_MODULE_0_react__["Children"].only(this.props.children));
    }
}
...
class Autocomplete extends __WEBPACK_IMPORTED_MODULE_0_react__["PureComponent"] {
    ...
    render() {
        return __WEBPACK_IMPORTED_MODULE_0_react__["createElement"]("div", { ref: this.containerElement, className: this.props.className || '' }, __WEBPACK_IMPORTED_MODULE_0_react__["Children"].only(this.props.children));
    }
}
...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(/*! ./../../../webpack/buildin/global.js */ 9), __webpack_require__(/*! ./../../../process/browser.js */ 10)))
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss__ = __webpack_require__(/*! ./editor.scss */ 13);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__editor_scss__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__style_scss__ = __webpack_require__(/*! ./style.scss */ 14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__style_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__style_scss__);
...
var event = new Event('EverythingImage::Update');
...
registerBlockType('gb/block-posts', {
	...
	edit: function edit(props) {
		...
		var fetchExcludePosts = function fetchExcludePosts(postType) {
		...
		var updateSelectedExcludedPosts = function updateSelectedExcludedPosts(selected) {

			// Extract buoy IDs
			var newIds = allPosts.filter(function (post) {
				return selected.includes(post.label);
			}).map(function (post) {
				return post.id;
			});
			console.log(newIds);
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					...
					wp.element.createElement(
						...
						attributes.taxonomy ? wp.element.createElement(
							'div',
							{ className: 'term-controls' },
							wp.element.createElement(TextControl, {
								label: 'Term',
							...
							allPosts.length > 0 ? wp.element.createElement(FormTokenField, {
								label: 'Exclude posts',
								value: allPosts.filter(function (post) {
									return attributes.excludePosts.includes(post.id);
								}).map(function (post) {
									return post.label;
								}),
								suggestions: allPosts.map(function (post) {
									return post.label;
								}),
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss__ = __webpack_require__(/*! ./editor.scss */ 16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__editor_scss__);
...
registerBlockType('gb/block-terms', {
	...
	icon: 'sticky',
	category: 'common',
	keywords: [__('Terms by Type'), __('Appearance')],
	attributes: {
		isInPostFetch: {
			type: 'boolean',
			default: false
	...
	edit: function edit(props) {
		...
		return wp.element.createElement(
			...
			wp.element.createElement(
				...
				wp.element.createElement(
					PanelBody,
					{ title: 'Terms Settings', icon: more, initialOpen: true },
					wp.element.createElement(
						'div',
						null,
						wp.element.createElement(TextControl, {
						...
						wp.element.createElement(TextControl, {
							...
							onChange: function onChange(newOrderBy) {
								return setAttributes({ orderBy: newOrderBy });
							},
							help: 'Leave empty for all terms'
						}),
						wp.element.createElement(TextControl, {
						...
						wp.element.createElement(CheckboxControl, {
							...
							onChange: function onChange(newHideEmpty) {
								return setAttributes({ hideEmpty: newHideEmpty });
							}
						})
					)
				)
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss__ = __webpack_require__(/*! ./editor.scss */ 19);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__editor_scss__);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_classnames__ = __webpack_require__(/*! classnames */ 22);
...
addFilter('blocks.getSaveContent.extraProps', 'gb/applyExtraClass', applyExtraClass);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss__ = __webpack_require__(/*! ./editor.scss */ 24);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__editor_scss___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__editor_scss__);
